...
const features: Feature[] = [
  {
    id: 'lead',
    title: '👁️ עיני — מוצא מי מחפש אותך',
    bullets: [
      'כל יום, אלפי אנשים כותבים ברשתות שהם מחפשים שירות כמו שלך. עיני סורק פייסבוק, גוגל, פורומים ועוד — ומביא לך רק את מי שרלוונטי.',
      'כל ליד מקבל ציון רלוונטיות, סיכום AI, והמלצת פעולה. אתה רק צריך להגיב.',
    ],
    details: [
      'ציון רלוונטיות 0-100',
      'סיכום AI של מה שהאדם מחפש',
      'המלצת פעולה: פנה עכשיו / שמור / לא מתאים',
      'קישור ישיר לפוסט המקורי',
    ],
    summary: 'התוצאה: רשימה יומית של אנשים שמחפשים בדיוק מה שאתה מציע — מוכנים לשמוע ממך.',
  },
  {
    id: 'competitor',
    title: '👀 המתחרים שלי — תמיד צעד אחד קדימה',
    bullets: [
      'עיני עוקב אחרי כל מתחרה שלך. כל שינוי מחיר, ביקורת חדשה, מבצע או פרסומת — אתה תדע ראשון.',
      'מתחרה חדש נפתח? מתחרה ישן נסגר? תקבל התראה מיידית.',
    ],
    details: [
      'שינויי מחירים — גילית לפני הלקוחות שלך',
      'ביקורות חדשות — ראה מה אומרים עליהם',
      'פרסומות ומבצעים — הבן את האסטרטגיה שלהם',
      'עסקים חדשים שנפתחו — התראה מיידית',
      'עסקים שנסגרו — הזדמנות לתפוס את הלקוחות שלהם',
    ],
    summary: 'לא צריך לבדוק ידנית. לא צריך לגגל מתחרים. עיני עושה את זה בשבילך — 24/7.',
  },
  {
    id: 'health',
    title: '🧠 המוח — 3 דברים שיזיזו את היום שלך',
    bullets: [
      'הבעיה היא לא חוסר מידע. הבעיה היא יותר מדי מידע — ולא ברור מה לעשות קודם.',
      'כל בוקר, המוח מכין לך 3 פעולות ספציפיות. לא 20 סעיפים. לא "כדאי לשקול". 3 דברים שאתה יכול לעשות עכשיו.',
    ],
    details: [],
    examples: [
      '"מישהו מחפש את השירות שלך — פנה אליו עכשיו"',
      '"המתחרה הגדיל מחירים ב-15% — ההזדמנות שלך"',
      '"יום ירושלים מחר — הכנתי לך פוסט מוכן"',
    ],
    summary: '',
  },
  {
    id: 'pdf',
    title: '📊 דוח שבועי — כמו שיש לחברות גדולות',
    bullets: [
      'כל יום ראשון, דוח PDF מקצועי ממתין לך. ציון בריאות, השוואת מתחרים, מגמות ותוכנית פעולה.',
    ],
    details: [
      'ציון בריאות העסק — 0 עד 100',
      'השוואה מלאה למתחרים: דירוג, ביקורות, מחירים',
      'ניתוח לידים: כמה נמצאו, כמה פוטנציאל',
      'מגמות שוק לשבוע הבא',
      'תוכנית פעולה מומלצת — 5 נקודות',
    ],
    summary: 'חברות גדולות משלמות עשרות אלפים בשנה על דוחות כאלה. כאן זה נוצר אוטומטית, כל שבוע.',
  },
  {
    id: 'whatsapp',
    title: '📱 העוזרים באים אליך — וואטסאפ',
    bullets: [
      'לא צריך לזכור להיכנס לפלטפורמה. העוזרים שולחים לך את מה שחשוב ישירות לוואטסאפ:',
    ],
    alerts: [
      { color: '#ff4466', label: 'דחוף ❗', text: '"מתחרה חדש נפתח 300 מטר ממך"' },
      { color: '#ffaa00', label: 'שווה לדעת', text: '"5 לידים חמים ממתינים לתגובה"' },
      { color: '#00ff88', label: 'לידיעה', text: '"המתחרה הגדיל מחירים ב-10%"' },
    ],
    details: [],
    summary: 'סיכום בוקר כל יום — 3 דקות קריאה. התראות רק כשמשהו חשוב קורה. לא ספאם. לא רעש.',
  },
  {
    id: 'map',
    title: '🗺️ מפת המתחרים — ראה את כולם על מפה אחת',
    bullets: [
      'כל המתחרים על מפה אינטראקטיבית — עם דירוג, ביקורות ורמת איום. ראה מי מתחזק ומי נחלש.',
      'גלה אזורים "ריקים" שבהם אין תחרות — ההזדמנות שלך לצמוח.',
    ],
    details: [
      'מפה אינטראקטיבית עם כל המתחרים',
      'צביעה לפי רמה — מתחרה חזק, כדאי לעקוב, לא מאיים',
...
export default function Features() {
  useSEO(
    'העוזרים של Quieteyes | 6 עוזרים חכמים שעובדים בשבילך',
    'הכירו את 6 העוזרים החכמים של Quieteyes: עיני מוצא לידים, המוח מייעץ, הקול כותב תוכן, הכיס שומר על הכנסות, האוזן מקשיב ללקוחות, הטווח מסתכל קדימה.'
  );
        ...
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          <FadeInSection>
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold mb-6" style={{ letterSpacing: '-0.03em' }}>
              6 עוזרים חכמים שעובדים בשבילך
            </h1>
            <p className="text-lg max-w-2xl mx-auto" style={{ color: '#8899aa' }}>
              הם לא ישנים. הם סורקים, מנתחים, כותבים ומתריעים — כדי שאתה תוכל להתמקד בלעשות את מה שאתה הכי טוב בו
            </p>
          </FadeInSection>
        </div>
      </section>
